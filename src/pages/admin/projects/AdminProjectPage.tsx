  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h1 className="text-2xl font-bold text-gray-900">{t('adminProject.title')}</h1>
        <Button onClick={handleCreate}>
          <Plus size={18} />
          {t('adminProject.addProject')}
        </Button>
      </div>
      ...
      {filtered.length === 0 ? (
        <EmptyState icon={<FolderKanban size={48} />} title={t('common.noData')} />
      ) : (
